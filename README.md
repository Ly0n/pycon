# pycon
A conversion tool. :black_heart:  :black_heart: :black_heart: :black_heart: :black_heart: :black_heart: :black_heart: :black_heart: To convert to a reasonable sysem of units (aka. the metric system). Written in python3.
